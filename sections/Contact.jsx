...
const Contact = () => {
  ...
  return (
    <setion id="contact" className="w-full">
      <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-foreground dark:bg-foreground-dark rounded-lg shadow-lg">
        <div className="flex flex-col justify-between">
          <div>
            ...
            <div className="grid grid-cols-2 mt-14 mx-auto w-4/5 gap-10">
              <Link href="https://www.linkedin.com/in/mamadykonte">
                <a className="flex items-center justify-center rounded-full shadow-md shadow-main hover:scale-105 duration-200 p-3 cursor-pointer">
                  <FaLinkedin size={25} />
                </a>
              </Link>
        ...
        <form ref={form} onSubmit={sendEmail}>
          ...
          <div className="mt-8">
            <button className="uppercase text-sm font-bold tracking-wide bg-main text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
              Send Message
            </button>
          </div>
        </form>
